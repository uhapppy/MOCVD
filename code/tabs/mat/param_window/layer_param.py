...
class LayerParamWindow(QtWidgets.QWidget):
        ...
        if self.term > 0:
            ...
            if self.parameters_type_combobox.currentText() == "Center,Width,Area":
                for i, group in enumerate(self.groups):
                    ...
                    file.write(
                        f"{group.param_label_1.text()}   , {group.input_min_1.text()} , {group.input_max_1.text()} \n")
                    file.write(
                        f"{group.param_label_2.text()}  , {group.input_min_2.text()} , {group.input_max_2.text()} \n")
                    file.write(
                        f"{group.param_label_3.text()}  , {group.input_min_3.text()} , {group.input_max_3.text()} \n")
    ...
    def get_data(self):
        ...
        data["thickness"] = dict(low=9999.999999,high = 9999.999999)
